...
- **China Software Copyright:Automated BIM Structural Component Matching System Based on Keypoint Cloud Recognition and Fusion (V1.0)**: 2023SR0614875 · Issued Jun 9, 2023; Developed an intelligent matching system for prefabricated building BIM structural components using keypoint cloud recognition and multi-source data fusion. Led the architecture design, core algorithm development, and system integration, enabling automated component identification and matching in modular construction scenarios;
